...
audit trail, Redis stores, adapters, dashboard, and observability.

Enterprise adds the features that production platforms at scale require.
...
|---|---|---|
| **Multi-tenancy data isolation** | Roadmap v1.3 | One deployment, many teams, zero data leakage between tenants |
...
| **Scheduled execution (advanced)** | Roadmap v1.3 | Timezone-aware cron, webhook triggers, SLA tracking |
| **AFMX Cloud** | Roadmap v2.0 | Managed hosting, multi-region, automatic scaling, zero infrastructure |
| **Enterprise SLA + support** | Available now | Dedicated support, architecture reviews, security advisories |

---

## Documentation

Full documentation: **[afmx.inteleion.com/docs](https://afmx.inteleion.com/docs)**

---

## Contact

**support@inteleion.com**
